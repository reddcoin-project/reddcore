...
describe('Script', function() {
  ...
  describe('#buildPublicKeyHashOut', function() {
    it('should create script from livenet address', function() {
      var address = Address.fromString('RdWMYzJy7FTkG2hngpXsvvUivYSvs4YvUc');
      var s = Script.buildPublicKeyHashOut(address);
      should.exist(s);
      s.toString().should.equal('OP_DUP OP_HASH160 20 0x35a0d6719165cf97e55d623057d37a5a29c7fae7 OP_EQUALVERIFY OP_CHECKSIG');
      s.isPublicKeyHashOut().should.equal(true);
      s.toAddress().toString().should.equal('RdWMYzJy7FTkG2hngpXsvvUivYSvs4YvUc');
    });
  ...
  describe('#buildScriptHashOut', function() {
    ...
    it('inherits network property from other script', function() {
      var s1 = new Script.fromAddress(new Address('RhQbigwBAu7EajFTe6MP59GcBJF5cNMNMf'));
  ...
  describe('getData returns associated data', function() {
    ...
    it('for a P2PKH address', function() {
      var address = Address.fromString('Rk7659jwP4STZ9sSBrWzmSreQCbcHFSYzW');
  ...
  describe('toAddress', function() {
    ...
    it('for a P2PKH address', function() {
      var stringAddress = 'Rutz7AqwjxbMJxfZ6BncbFexDzpEAKnzcF';
    ...
    it('works for p2pkh output', function() {
      ...
      script.toAddress().toString().should.equal('RrvwscFAZHQ3uKbdGK18sEQRd3fagmwWoz');
    });
    it('works for p2pkh input', function() {
      ...
      s2.toAddress().toString().should.equal('Rf6xv9GqjEN9yo1A6mo1PBYhV9RKbUSdKV');
    });
